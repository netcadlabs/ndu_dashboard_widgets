...
class LabelCardWidget extends BaseDashboardWidget {
  ...
  @override
  _LabelCardWidgetState createState() => _LabelCardWidgetState();
}

class _LabelCardWidgetState extends BaseDashboardState<LabelCardWidget> {
  ...
  void initState() {
    ...
    if(widget.widgetConfig.config.settings.backgroundImageUrl!=null){
      backgroundImageUrl=widget.widgetConfig.config.settings.backgroundImageUrl;
